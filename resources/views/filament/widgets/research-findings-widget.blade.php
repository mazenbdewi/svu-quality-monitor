<style>
    @media (max-width: 1023px) {
        .research-findings-grid { grid-template-columns: repeat(2, minmax(0, 1fr)) !important; }
    }

    @media (max-width: 639px) {
        .research-findings-grid { grid-template-columns: minmax(0, 1fr) !important; }
    }
</style>
...
<x-filament-widgets::widget dir="rtl">
    <section aria-labelledby="research-findings-heading">
        ...
        <div class="research-findings-grid" style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 1.25rem;">
